  ...
  <div class="header__inner">
    ...
    <div class="logo-and-search">
      <div class="logo-wrapper">
        <?php if ($logo): ?>
          <?php
            $logo_alt = theme_get_setting('doeeem_theme_header_logo_alt');
            ...
            if (empty(theme_get_setting('doeeem_theme_header_title'))) {
              $logo_class[] = 'no-title';
            }
          ...
          ?>
        <?php endif; ?>
        <?php if (theme_get_setting('doeeem_theme_header_title')): ?>
          <div class="header-title"><?php print decode_entities(theme_get_setting('doeeem_theme_header_title')); ?></div>
        <?php endif; ?>
      </div>
